...
* Actually setup indexes in MongoDB when the collections don't already exist
* Command line argument or other way of forcing a full refresh of a replica
* Ensure two instances of Mongar can't run simultaneously as it might cause problems with full refreshes
